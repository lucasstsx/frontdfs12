  ...
  return (
    ...
    >
      <div className={`${round ? 'p-0 m-0' : 'mb-4 p-5'}`}>
        <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-secondary/20">
          {item.icon}
        </span>
      </div>
      <div className="p-5">
        <div className="mb-1 font-bold text-base text-foreground">{item.title}</div>
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden p-4 ${
        round ? 'rounded-full border border-secondary' : 'rounded-[24px] border border-border'
      }`}
      style={{
        width: `${baseWidth}px`,
